  ...
  //
  // linkedin / calendly: paste each person's URL here. Leave a value as '' and
  // that button simply is not rendered in the bio, so non-advisors can have a
  // LinkedIn link without a scheduling link.
  const team = [
    {name:'Michael Collins', creds:'CFA', role:'Founder &amp; CEO', slug:'michael-collins',
     linkedin:'https://www.linkedin.com/in/michaelcollinspm/', calendly:'https://calendly.com/wincapfinancial',
    ...
    {name:'Zach Ciampa', creds:'CFP&reg;, RICP&reg;, ChFC&reg;, BFA&trade;', role:'Head of Financial Planning', slug:'zach-ciampa',
     linkedin:'https://www.linkedin.com/in/zachary-ciampa-cfp%C2%AE-ricp%C2%AE-chfc%C2%AE-bfa%E2%84%A2-a5924bb5/', calendly:'https://calendly.com/zciampa',
    ...
    {name:'Luke Pavlatos', creds:'CFP&reg;', role:'Senior Wealth Manager', slug:'luke-pavlatos',
     linkedin:'https://www.linkedin.com/in/luke-pavlatos-cfp%C2%AE-5b010bb4/', calendly:'https://calendly.com/lpavlatos-wincapfinancial',
    ...
    {name:'Joseph Lepore', role:'Senior Wealth Manager', slug:'joseph-lepore',
     linkedin:'https://www.linkedin.com/in/joseph-l-3303808a/', calendly:'https://calendly.com/jlepore-wincapfinancial',
    ...
    {name:'Joseph Duran', role:'Senior Wealth Manager', slug:'joseph-duran',
     linkedin:'https://www.linkedin.com/in/joseph-duran-69562839/', calendly:'https://calendly.com/jduran-wincapfinancial',
    ...
    {name:'Frank Mahoney', role:'Chief of Staff', slug:'frank-mahoney',
     linkedin:'https://www.linkedin.com/in/frankmahoneywincap/', calendly:'',
    ...
    {name:'Drew Crowley', role:'Head of Artificial Intelligence', slug:'drew-crowley',
     linkedin:'https://www.linkedin.com/in/drew-crowley-415a18258', calendly:'',
  ...
  if (teamGrid) {
    ...
    const openBio = (m, trigger) => {
      ...
      // without a Calendly link just gets LinkedIn and nobody gets a dead link.
      const acts = [];
      if (m.linkedin) {
      ...
      if (m.calendly) {
        acts.push('<a class="bio-act bio-act-primary" href="' + m.calendly + '" target="_blank" rel="noopener">' +
